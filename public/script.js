 const canvas = document.getElementById('canvas');
  ...
  function updateFontLoadingProgress() {
    const totalFonts = WebFont.families ? WebFont.families.length : 0;
    const loadedFonts = WebFont.active ? WebFont.active.length : 0;
    const percentage = totalFonts > 0 ? Math.round((loadedFonts / totalFonts) * 100) : 0;
